...
export default class MonacoScript extends WidgetBase<WidgetProperties> {
	...
	private readonly _proxyUrl = '../support/worker-proxy.js'; // TODO: this should not be hard-coded
	private readonly _editorModuleId = 'vs/editor/editor.main';
	private readonly _loaderSrc = '../vs/loader.js'; // TODO: this should not be hard-coded
